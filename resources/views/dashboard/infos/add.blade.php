            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Add Infos</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form class="forms-sample" method="POST" action="{{route('infos.store')}}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <input type="text" id="facebook" value="{{old('facebook')}}" name="facebook"
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <input type="text" id="insta" value="{{old('insta')}}" name="insta"
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <input type="text" id="linkdin" value="{{old('linkdin')}}" name="linkdin"
                    ...
                    <button type="submit" class="btn btn-success waves-effect waves-light">Add Infos</button>
                    </form>
                </div>
            </div>
        </div> <!-- end col -->
