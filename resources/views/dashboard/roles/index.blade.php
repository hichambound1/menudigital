                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu shadow rounded" style="min-width: 72px !important;border:none" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <p class="dropdown-item " style="padding: 7px;">
                                            <a href="{{route('role.edit',$item->id)}}" class="text-warning">Edit<i class="ti-pencil p-2"></i></a>
                                        </p>
                                        <p class="dropdown-item " style="padding: 7px;">
                                            <a href="{{route('role.show',$item->id)}}" class="text-info">Details<i class="ti-more p-1 "></i></a>
                                        </p>
